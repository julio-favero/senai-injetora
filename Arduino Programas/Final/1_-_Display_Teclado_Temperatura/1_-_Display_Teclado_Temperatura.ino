  ...
  if (leitura_teclas) { // Se alguma tecla foi pressionada
     ...
     if(leitura_teclas == 'C')
     {
            //Fecha Molde------------------------------------------------------------------------------------
              ...
              digitalWrite(12,LOW); //Aqui é primeiro giro do projeto, fechamento do molde
        
              for (giro1= 0; giro1<=1000; giro1++){ //Aqui você faz o preset de quanto ele vai andar, quando for fazer o preset, zere o valor dos outros giros. 
          ...
          //Injeção de Material----------------------------------------------------------------------------
              ...
              for (giro2= 0; giro2<=1000; giro2++){ // Aqui você define o tanto que o fuso vai rodar, recomendo 11000
                digitalWrite(driver2PUL,HIGH);
                delayMicroseconds(pd);
                digitalWrite(driver2PUL,LOW);
                delayMicroseconds(pd);
          ...
          //Retira Pressão----------------------------------------------------------------------------      
              ...
              for (giro3= 0; giro3<=1000; giro3++){ //Recomendo colocar 2000 aqui
                digitalWrite(driver2PUL,HIGH);
                delayMicroseconds(pd);
                digitalWrite(driver2PUL,LOW);
                delayMicroseconds(pd);
          ...
          //-----------------------------------------------------------------------------------------------
              delay (1000); // Este é o tempo de espera para o molde abrir
         
          //Abre Molde----------------------------------------------------------------------------      
              digitalWrite(11,HIGH); // Está ultima operação abre o molde
        
              for (giro4= 0; giro4<=1000; giro4++){ //Aqui o valor deve ser igual ao do fechamento do molde, pois abre a mesma quantidade.
                digitalWrite(driver1PUL,HIGH);
                delayMicroseconds(pd);
                digitalWrite(driver1PUL,LOW);
                delayMicroseconds(pd);
